...
function selected(cal, date) {
  ...
  //RLG: llama al onchange del input
  if(cal.sel.onchange){
    cal.sel.onchange();
  }
...
function closeHandler(cal) {
  ...
  calendar = null; //Para que en la misma pagina pueda haber instancias distintas del calendario
...
function showCalendar(id, format, disableHandler) {
  ...
  if (calendar != null) {
    ...
    if(disableHandler != null){
      cal.setDisabledHandler(disableHandler);
    }
